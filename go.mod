...
require (
	code.cryptopower.dev/group/cryptopower/libwallet/lightning v0.0.0
...
require (
	...
	github.com/lightningnetwork/lnd v0.15.4-beta // indirect
...
replace code.cryptopower.dev/group/cryptopower/libwallet/lightning => ./libwallet/lightning

replace github.com/lightningnetwork/lnd => github.com/breez/lnd v0.16.2-breez
