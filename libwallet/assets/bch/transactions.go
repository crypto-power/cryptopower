...
func (asset *Asset) PublishUnminedTransactions() error {
	...
	for _, tx := range mempoolTxs {
		...
		if err := asset.Internal().BCH.PublishTransaction(decodeTx); err != nil {
			return err
		}
	}
	return nil
...
func (asset *Asset) TxMatchesFilter(_ *sharedW.Transaction, txFilter int32) bool {
	return txhelper.TxDirectionInvalid != asset.bchSupportedTxFilter(txFilter)
}
...
func (asset *Asset) bchSupportedTxFilter(txFilter int32) int32 {
	switch txFilter {
...
func (asset *Asset) filterTxs(offset, limit, txFilter int32, newestFirst bool) ([]*sharedW.Transaction, error) {
	txType := asset.bchSupportedTxFilter(txFilter)
