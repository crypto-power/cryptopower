...
type websocketFeed interface {
	...
	// On returns true if the websocket connection is still open.
	On() bool
...
// Read is a wrapper for gorilla's ReadMessage that satisfies
// websocketFeed.Read.
...
// On returns true if the websocket connection is still open. Satisfies
// websocketFeed.On.
