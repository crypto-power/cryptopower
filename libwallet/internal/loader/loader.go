...
type AssetLoader interface {
	...
	CreateWatchingOnlyWallet(ctx context.Context, extendedPubKey string, pubPass []byte) (*LoaderWallets, error)
	CreateNewWallet(ctx context.Context, pubPassphrase, privPassphrase, seed []byte) (*LoaderWallets, error)
	OpenExistingWallet(ctx context.Context, pubPassphrase []byte) (*LoaderWallets, error)
	GetLoadedWallet() (*LoaderWallets, bool)
	UnloadWallet() error
}

func NewLoader(netType, dbDirPath string) *Loader {
	return &Loader{
		DbDirPath: dbDirPath,
