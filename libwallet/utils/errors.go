...
var (
	...
	ErrBCHNotInitialized = errors.New("bch asset not initialized")
...
func ErrBCHMethodNotImplemented(method string) error {
	return fmt.Errorf("%v not implemented for the %v Asset", method, BCHWalletAsset)
}
