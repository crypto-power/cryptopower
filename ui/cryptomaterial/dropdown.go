...
// of the dropdown in a dropdown group on the UI, the first dropdown should be
// assigned pos 0, next 1..etc. incorrectly assigned Dropdown pos will result in
// inconsistent dropdown backdrop.
