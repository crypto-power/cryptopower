...
// reduced the image original scale of 1 by half to 0.5 fix blurry images this
// in turn reduced the image layout size by half. Multiplying the layout size by
// 2 to give the original image size to scale ratio.
