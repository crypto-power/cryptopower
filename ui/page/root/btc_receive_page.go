...
// const BTCReceivePageID = "BTCReceive"

// type BTCReceivePage struct {
// 	*load.Load
...
// func NewBTCBTCReceivePage(l *load.Load) *BTCReceivePage {
// 	pg := &BTCReceivePage{
// 		Load:             l,
// 		GenericPageModal: app.NewGenericPageModal(BTCReceivePageID),
...
// 		})
// 	pg.selector.SelectFirstValidAccount(l.WL.SelectedBTCWallet.Wallet)
...
// func (pg *BTCReceivePage) OnNavigatedTo() {
...
// func (pg *BTCReceivePage) generateQRForAddress() {
...
// // Part of the load.Page interface.
// func (pg *BTCReceivePage) Layout(gtx C) D {
...
// func (pg *BTCReceivePage) layoutDesktop(gtx layout.Context) layout.Dimensions {
...
// func (pg *BTCReceivePage) layoutMobile(gtx layout.Context) layout.Dimensions {
// 	pageContent := []func(gtx C) D{
// 		func(gtx C) D {
// 			return pg.pageSections(gtx, func(gtx C) D {
// 				return pg.selector.Layout(pg.ParentWindow(), gtx)
...
// func (pg *BTCReceivePage) pageSections(gtx layout.Context, body layout.Widget) layout.Dimensions {
// 	return pg.Theme.Card().Layout(gtx, func(gtx C) D {
...
// func (pg *BTCReceivePage) pageBackdropLayout(gtx C) {
// 	if pg.isNewAddr {
// 		gtx.Constraints.Min.X = gtx.Constraints.Max.X
...
// func (pg *BTCReceivePage) topNav(gtx C) D {
...
// func (pg *BTCReceivePage) titleLayout(gtx C) D {
...
// func (pg *BTCReceivePage) addressLayout(gtx C) D {
...
// // displayed.
// // Part of the load.Page interface.
// func (pg *BTCReceivePage) HandleUserInteractions() {
...
// func (pg *BTCReceivePage) generateNewAddress() (string, error) {
...
// func (pg *BTCReceivePage) handleCopyEvent(gtx C) {
...
// // Part of the load.Page interface.
// func (pg *BTCReceivePage) OnNavigatedFrom() {
// 	pg.ctxCancel()
// }
