...
// func NewMainPageOld2(l *load.Load) *MainPageOld {
// 	mp := &MainPageOld{
// 		Load:       l,
// 		MasterPage: app.NewMasterPage(MainPageOldID),
...
// func (mp *MainPageOld) ID() string {
// 	return MainPageOldID
// }

// func (mp *MainPageOld) initNavItems() {
...
// // Part of the load.Page interface.
// func (mp *MainPageOld) OnNavigatedTo() {
// 	mp.setNavExpanded()
...
// func (mp *MainPageOld) isGovernanceAPIAllowed() bool {
// 	return mp.WL.AssetsManager.IsHTTPAPIPrivacyModeOff(libutils.GovernanceHTTPAPI)
// }

// func (mp *MainPageOld) updateExchangeSetting() {
...
// func (mp *MainPageOld) fetchExchangeRate() {
...
// func (mp *MainPageOld) updateBalance() {
...
// func (mp *MainPageOld) OnDarkModeChanged(isDarkModeOn bool) {
...
// func (mp *MainPageOld) OnCurrencyChanged() {
// 	mp.updateExchangeSetting()
// }
...
// // displayed.
// // Part of the load.Page interface.
// func (mp *MainPageOld) HandleUserInteractions() {
// 	if mp.CurrentPage() != nil {
...
// func (mp *MainPageOld) KeysToHandle() key.Set {
...
// // Satisfies the load.KeyEventHandler interface for receiving key events.
// func (mp *MainPageOld) HandleKeyPress(evt *key.Event) {
// 	if currentPage := mp.CurrentPage(); currentPage != nil {
// 		if keyEvtHandler, ok := currentPage.(load.KeyEventHandler); ok {
...
// // Part of the load.Page interface.
// func (mp *MainPageOld) OnNavigatedFrom() {
...
// // Part of the load.Page interface.
// func (mp *MainPageOld) Layout(gtx C) D {
...
// func (mp *MainPageOld) layoutDesktop(gtx C) D {
...
// func (mp *MainPageOld) layoutMobile(gtx C) D {
...
// func (mp *MainPageOld) LayoutUSDBalance(gtx C) D {
...
// func (mp *MainPageOld) totalAssetBalance(gtx C) D {
...
// func (mp *MainPageOld) LayoutTopBar(gtx C) D {
...
// func (mp *MainPageOld) postDesktopNotification(notifier interface{}) {
...
// func (mp *MainPageOld) listenForNotifications() {
...
// 	err := selectedWallet.AddSyncProgressListener(mp.SyncProgressListener, MainPageOldID)
// 	if err != nil {
...
// 	err = selectedWallet.AddTxAndBlockNotificationListener(mp.TxAndBlockNotificationListener, true, MainPageOldID)
// 	if err != nil {
...
// 		err = mp.WL.AssetsManager.Politeia.AddNotificationListener(mp.ProposalNotificationListener, MainPageOldID)
// 		if err != nil {
...
// 	err = mp.WL.AssetsManager.InstantSwap.AddNotificationListener(mp.OrderNotificationListener, MainPageOldID)
// 	if err != nil {
...
// 				}
// 			case <-mp.ctx.Done():
// 				selectedWallet.RemoveSyncProgressListener(MainPageOldID)
// 				selectedWallet.RemoveTxAndBlockNotificationListener(MainPageOldID)
// 				mp.WL.AssetsManager.Politeia.RemoveNotificationListener(MainPageOldID)
// 				mp.WL.AssetsManager.InstantSwap.RemoveNotificationListener(MainPageOldID)
...
// func (mp *MainPageOld) showBackupInfo() {
