...
"importantSeedPhrase" = "The 33-word seed word is EXTREMELY IMPORTANT."
"seedPhraseToRestore" = "seed word is the only way to restore your wallet."
"howToStoreSeedPhrase" = "It is recommended to store your seed word in a physical format (e.g. write down on a paper)."
"howNotToStoreSeedPhrase" = "It is highly discouraged to store your seed word in any digital format (e.g. screenshot)."
"hideSeedPhrase" = "Anyone with your seed word can steal your funds. DO NOT show it to anyone."
"peers" = "peers";
...
"abstain" = "Abstain"
"seedPhraseVerified" = "Your seed word backup is verified"
"sureToSafeStoreSeed" = "Be sure to store your seed word backup in a secure location."
