...
"online" = "Online, "
"onlineCheckAPI" = "Online Wallet Check"
...
"privacyModeInfoDesc" = "When enabled all HTTP API calls are disabled, with the exception of (Online Network Check) API that is used to check if wallet has internet access"
