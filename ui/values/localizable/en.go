...
"cexContent" = "The Centralized Exchange(CEX) is a system that enables exchange of currency using secure third-party providers. This system of exchange is simple, quick, and secure."
...
"rescanInvalid" = "Another synchronization is currently in progress. Rescanning is not possible."
"connectNetworkFailed" = "Connection to the blockchain network is unavailable."
"restore" = "Restore"
...
"setUpStakeShuffleIntroDesc" = "The Shuffle++ mixer can mix your %s through CoinJoin transactions."
"setUpStakeShuffleIntroSubDesc" = "Using mixed %s protects you from exposing your financial activities to the public (e.g. how much you own, who pays you)."
...
"dataFileErrorBody" = "We have detected a problem with your data files from an older version. To fix it, we need to re-create database and you will need to re-enter your wallet seed phrase. Can you do this now?"
"warningMigrate" = "We have detected a problem with your data files from an older version. To fix it, you will need to migrate to new database. Can you do this now?"
"databaseType" = "Database type"
"migrateWallet" = "Migrate Wallet"
"willMigrate" = "Will Migrate"
"doNotMigrate" = "Do It later!"
"migrateNow" = "Migrate"
