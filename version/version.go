...
// go build -v -ldflags "-X gitlab.com/cryptopower/cryptopower/version.appPreRelease= -X gitlab.com/cryptopower/cryptopower/version.appBuild=`git rev-parse --short HEAD`"
var (
